...
(defn add
  ...
  ([pt1 pt2]
   (add pt1 (x pt2) (y pt2)))
  ([pt x y]
   (add (falx.engine.point/x pt) (falx.engine.point/y pt) x y))
  ([x1 y1 x2 y2]
   [(long (+ x1 x2))
    (long (+ y1 y2))]))
...
(defn sub
  ...
  ([pt1 pt2]
   (sub pt1 (x pt2) (y pt2)))
  ([pt x y]
   (sub (falx.engine.point/x pt) (falx.engine.point/y pt) x y))
  ([x1 y1 x2 y2]
   [(long (- x1 x2))
    (long (- y1 y2))]))
...
(defn mult
  ...
  ([pt] pt)
  ([pt1 pt2]
   (mult pt1 (falx.engine.point/x pt2) (falx.engine.point/y pt2)))
  ([pt x y]
   (mult (falx.engine.point/x pt) (falx.engine.point/y pt) x y))
  ([x1 y1 x2 y2]
   [(long (* x1 x2))
    (long (* y1 y2))]))
...
(defn div
  ...
  ([pt1 pt2]
   (div pt1 (x pt2) (y pt2)))
  ([pt x y]
   (div (falx.engine.point/x pt) (falx.engine.point/y pt) x y))
  ([x1 y1 x2 y2]
   [(long (/ x1 x2))
    (long (/ y1 y2))]))
...
(defn direction
  ...
  ([pt x y]
   (direction (falx.engine.point/x pt) (falx.engine.point/y pt) x y))
  ([x1 y1 x2 y2]
